...
if numfiles ~= 20
	error('There are %d files. Error! You must have 20 files!', numfiles);	
else
	disp('There are 20 files. Correct!');
	accZ3_1 = importOneData(txtFiles(1).name, sample_rate);
	accZ5_1 = importOneData(txtFiles(2).name, sample_rate);
	accZ3_3 = importOneData(txtFiles(3).name, sample_rate);
	accZ5_3 = importOneData(txtFiles(4).name, sample_rate);
	accZ3_5 = importOneData(txtFiles(5).name, sample_rate);
	accZ5_5 = importOneData(txtFiles(6).name, sample_rate);
	accZ3_7 = importOneData(txtFiles(7).name, sample_rate);
	accZ5_7 = importOneData(txtFiles(8).name, sample_rate);
	accZ3_9 = importOneData(txtFiles(9).name, sample_rate);
	accZ5_9 = importOneData(txtFiles(10).name, sample_rate);
	accZ4_1 = importOneData(txtFiles(11).name, sample_rate);
	accZ6_1 = importOneData(txtFiles(12).name, sample_rate);
	accZ4_3 = importOneData(txtFiles(13).name, sample_rate);
	accZ6_3 = importOneData(txtFiles(14).name, sample_rate);
	accZ4_5 = importOneData(txtFiles(15).name, sample_rate);
	accZ6_5 = importOneData(txtFiles(16).name, sample_rate);
	accZ4_7 = importOneData(txtFiles(17).name, sample_rate);
	accZ6_7 = importOneData(txtFiles(18).name, sample_rate);
	accZ4_9 = importOneData(txtFiles(19).name, sample_rate);
	accZ6_9 = importOneData(txtFiles(20).name, sample_rate);
